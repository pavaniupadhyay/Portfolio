...
export const GlareCard = ({
  ...
  return (
    ...
    >
      <div className="h-full grid will-change-transform origin-center transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] [transform:rotateY(var(--r-x))_rotateX(var(--r-y))] rounded-calc(var(--radius) - 4px)   hover:[--duration:200ms] hover:[--easing:linear] hover:filter-none overflow-hidden md:w-[1090px] md:h-[510px] [clip-path:inset(0_0_0_0_round_var(--radius))] ">
